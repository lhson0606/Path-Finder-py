...
class VisualizedGreedy(VisualizedAlgorithm.VisualizedAlgorithm):
    ...
    def find_path(self, start: glm.ivec3, goal: glm.ivec3):
        return self.greedy_search(start, goal, self.map)
        pass
    ...
    def greedy_search(self, start: glm.ivec3, goal: glm.ivec3, m: Map):
        open_set = [(0, start)]
        came_from = {}
